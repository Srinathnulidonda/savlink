// src/dashboard/views/MyFiles/useMyFilesData.js
import { useState, useEffect, useCallback } from 'react';
import { LinksService } from '../../../services/links.service';
import { FoldersService } from '../../../services/folders.service';

export default function useMyFilesData({ searchQuery, sortBy, filters }) {
    ...
    const fetchData = useCallback(async (reset = false) => {
        try {
            ...
            if (filters.folder_id === 'unassigned') params.unassigned_only = true;
    ...
    // Reset data when search/filters change
    useEffect(() => {
        setCursor(null);
        fetchData(true);
