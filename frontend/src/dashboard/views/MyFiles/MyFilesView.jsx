// src/dashboard/views/MyFiles/FilesGrid.jsx - Mobile responsive
...
export default function FilesGrid({
    ...
    const containerClasses = viewMode === 'grid'
        ? "grid gap-3 sm:gap-4 grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5"
