    ...
    <>
      ...
      >
        ...
        <div className="px-3 pt-2">
          <button onClick={() => { navigate('/dashboard/my-files'); onClose(); }}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-[13px] font-medium text-gray-400 hover:text-gray-200 hover:bg-white/[0.03] transition-colors touch-manipulation">
