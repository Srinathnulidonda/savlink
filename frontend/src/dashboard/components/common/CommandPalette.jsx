// src/dashboard/components/common/CommandPalette.jsx
import { useState, useEffect, useRef } from 'react';
import { motion } from 'framer-motion';
import { useNavigate } from 'react-router-dom';

export default function CommandPalette({ isOpen, onClose, onAddLink }) {
                                ...
                                {categoryCommands.map((command, index) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center justify-between rounded-lg px-3 py-2.5 text-xs sm:text-sm text-gray-400 hover:bg-gray-900 hover:text-white text-left transition-all ${
                                                globalIndex === selectedIndex ? 'bg-gray-900 text-white' : ''
                                            }`}
                                        >
