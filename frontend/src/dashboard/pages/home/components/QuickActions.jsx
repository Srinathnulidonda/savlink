...
export default function QuickActions({ onAddLink, onOpenSearch }) {
    const actions = [
        {
            id: 'add',
            label: 'Add new link',
                ...
                {actions.map((action, i) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Label */}
                            <span className="flex-1 text-[13px] text-gray-400 text-left 
                                ...
                                {action.keys.map((key, ki) => (
                                    <kbd
                                        ...
                                        className="min-w-[22px] h-[22px] flex items-center justify-center
                                                   ...
                                                   bg-gray-800/40 border border-gray-700/40 rounded-[5px]
                                                   px-1.5 leading-none"
                                    >
                                        {key}
                                    </kbd>
