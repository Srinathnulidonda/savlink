        ...
        <section className="rounded-xl border border-gray-800/50 bg-gray-900/20 overflow-hidden">
            ...
            {collections.length === 0 ? (
                <div className="px-5 py-12 text-center">
                    <div className="mx-auto w-10 h-10 rounded-xl bg-gray-800/30 border border-gray-800/50
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-gray-800/20">
                    {collections.slice(0, 6).map((col, i) => (
                        <motion.button
                            ...
                            className="flex items-center gap-3 px-5 py-3.5 bg-gray-950/80
                                       hover:bg-white/[0.02] transition-colors text-left group"
                        >
                            {/* Icon */}
                            <div className="w-10 h-10 rounded-xl bg-gray-800/40 border border-gray-800/50
                                            flex items-center justify-center flex-shrink-0
                                            group-hover:border-gray-700/50 group-hover:bg-gray-800/60 transition-all">
                            ...
                            {/* Arrow */}
                            <svg
                                className="w-3.5 h-3.5 text-gray-800 group-hover:text-gray-500 
