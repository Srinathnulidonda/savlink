// src/dashboard/pages/alllinks/AllLinksPage.jsx
import { useState, useEffect, useCallback, useRef } from 'react';
import { AnimatePresence } from 'framer-motion';
import { ContextMenuProvider } from '../../components/common/ContextMenu';
import { useAllLinks } from './useAllLinks';
import AllLinksHeader from '../alllinks/components/AllLinksHeader';
import AllLinksEmpty from '../alllinks/components/AllLinksEmpty';
...
export default function AllLinksPage({ 
  ...
  // Use external viewMode if provided, otherwise use local storage
  const [localViewMode, setLocalViewMode] = useState(() => {
    try { return localStorage.getItem('savlink_alllinks_view') || 'list'; } catch { return 'list'; }
  });
  ...
  const handleViewModeChange = externalOnViewModeChange || ((mode) => {
    ...
    try { localStorage.setItem('savlink_alllinks_view', mode); } catch {}
  });
