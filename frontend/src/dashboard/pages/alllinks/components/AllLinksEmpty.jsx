// src/dashboard/pages/alllinks/AllLinksEmpty.jsx
import { motion } from 'framer-motion';

export default function AllLinksEmpty({ searchQuery, onAddLink, onClearSearch }) {
  if (searchQuery) {
    return (
    ...
    <div className="flex flex-col items-center justify-center py-24 px-4">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }}
          ...
          className="w-16 h-16 rounded-2xl bg-gray-800/30 border border-gray-800/40
                     flex items-center justify-center mx-auto mb-5">
          <svg className="w-7 h-7 text-gray-600" fill="none" viewBox="0 0 24 24"
            stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round"
        ...
        <h3 className="text-[16px] font-medium text-white mb-2">No links yet</h3>
        <p className="text-[13px] text-gray-500 mb-6 leading-relaxed">
          Save your first link to get started. You can add links manually or import them.
        </p>
